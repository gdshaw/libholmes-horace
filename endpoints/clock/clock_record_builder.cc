...
clock_record_builder::clock_record_builder(session_builder& session, int channel):
	...
	_esterror_attr(session.define_attribute("clock_esterror", type_signed_integer), 0),
	_maxerror_attr(session.define_attribute("clock_maxerror", type_signed_integer), 0),
...
void clock_record_builder::add_esterror(int64_t esterror) {
	_attrs.insert(_esterror_attr = signed_integer_attribute(_esterror_attr.attrid(), esterror));
}

void clock_record_builder::add_maxerror(int64_t maxerror) {
	_attrs.insert(_maxerror_attr = signed_integer_attribute(_maxerror_attr.attrid(), maxerror));
}
