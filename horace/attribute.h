...
// Content types
static const int type_compound = 0;
static const int type_unsigned_integer = 1;
static const int type_signed_integer = 2;
static const int type_binary = 3;
static const int type_string = 4;
static const int type_timestamp = 5;
static const int type_boolean = 6;

// Reserved attribute IDs
static const int attrid_protocol = -1;
static const int attrid_attr_def = -2;
static const int attrid_attr_id = -3;
static const int attrid_attr_label = -4;
static const int attrid_chan_def = -5;
static const int attrid_chan_id = -6;
static const int attrid_chan_label = -7;
static const int attrid_type = -8;
static const int attrid_source = -9;
static const int attrid_seqnum = -10;
static const int attrid_ts = -11;
static const int attrid_time_system = -12;
static const int attrid_message = -13;
